---
name: zensu-plm
description: Zensu Product Lifecycle Manager — delegate ANY Zensu MCP interaction here; enforces workflow conventions and tool ordering.
tools: ["read", "grep", "glob", "@zensu"]
includeMcpJson: true
---
