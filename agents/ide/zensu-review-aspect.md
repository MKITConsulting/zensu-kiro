---
name: zensu-review-aspect
description: Single-perspective read-only reviewer; spawn five in one batch (one per perspective) and merge findings in the main thread.
