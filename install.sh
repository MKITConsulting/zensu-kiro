...
# Feed the trusted helper as program input. On Git Bash an installed/script
# path containing a semicolon can otherwise be reinterpreted as an MSYS path
# list before native Node receives argv.
